...
You can attempt to hide when you are not being observed and when you are in a heavily obscured area or have threequarters cover or better from an object (see [[Cover]]). 
...
Also, while hidden, you make all [[Attack]] rolls with 1 boon against the [[Defense]] or [[Agility]] of targets from which you are